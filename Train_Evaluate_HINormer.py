...
def main():
    ...
    parser.add_argument("--gnn-layers", type=int, default=2, help="Number of local heterogeneous structure layers.")
    parser.add_argument("--num-heads", type=int, default=4, help="Attention heads for HINormer.")
    parser.add_argument("--hinormer-layers", type=int, default=2, help="Number of relation-aware global attention layers.")
    parser.add_argument("--hinormer-beta", type=float, default=1.0, help="Relation-bias weight in HINormer attention.")
    ...
    parser.add_argument("--metapaths", type=str, default=None, help="Only used for schema printing; HINormer itself does not require metapaths.")
