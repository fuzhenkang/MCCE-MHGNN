...
def build_parser():
    parser = argparse.ArgumentParser(description="Unified link prediction training entrypoint.")
...
def main():
    ...
    encoder = build_encoder(args, message_graph, input_dims, metapaths, target_etype)
